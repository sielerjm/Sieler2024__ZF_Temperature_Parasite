...
# Example usage:
# Assuming `tmp.data.alpha` is your tibble and it contains columns "Alpha.Score", "Alpha.Metric", and other variables.
# result <- run_glm_models(tmp.data.alpha, "Alpha.Score", "Alpha.Metric", "Alpha.Score ~ Temperature")
